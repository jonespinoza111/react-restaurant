  ...
  return (
    <section id="about" className="bg-black flex flex-col  items-center xl:flex-row">
      <div className="left-side flex flex-col items-center  w-[90%] xl:w-[50%] h-auto pl-[1em] xl:px-[2em] py-[2em]">
        ...
        <h3 className="font-thin text-gray-300 text-[0.6em] sm:text-[0.8em] w-auto sm:w-[25em] text-wrap text-start mb-4">
        ...
        <h3 className="font-thin text-[0.6em] sm:text-[0.8em] w-auto sm:w-[25em] text-wrap text-start mb-4 text-yellow-100">
