...
const ReviewSection = () => {
  return (
    <div className="flex flex-col justify-start py-[2em] bg-white">
        <div className="">
            <h2 className="text-black leading-none w-auto text-[2em] uppercase">
              Customer Reviews
            </h2>
        </div>
        <div className="flex flex-row justify-center py-[2em] gap-x-[2em]">
        <div className="quote-card flex flex-col items-center justify-center w-[11em] shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px]">
            <div>
            <img
            ...
            <div className="info-card text-black flex flex-col px-10 py-5 bg-white h-[14em]">
