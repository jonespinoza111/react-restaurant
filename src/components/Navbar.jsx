...
const Navbar = () => {
    return (
        <nav className="flex flex-col lg:flex-row flex-wrap items-center justify-center md:justify-between px-4 py-3 bg-black sticky top-0 z-50 shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px]">
